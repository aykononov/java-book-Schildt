...
><small>
>
>*Эта глава для Idea добавляется в исключения (Chapter16) и выполняется из кмандной строки.* 
></small>
>
...
Это допускает некоторую оптимизацию, повышающую производительность общих операций над символьными строками. Все
три класса реализуют интерфейс *CharSequence*.
>
