...
>
>**Главное отличие Класса от Интерфейса** : В Классе могут сохраняться данные о стояния, особенно с помощью	переменных экземпляра, тогда как в Интерфейсе этого сделать нельзя.  
></details>
></small>
