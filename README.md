...
[Показать все Содержание ...](https://github.com/aykononov/book-on-java-Schildt/blob/master/README.md "весь список ...")
...
>Ctr + N                Поиск класса по имени и переход к нему  
...
>Ctr + Alt + O          Оптимизация импортов (Удаляет все НЕиспользуемые import`ы) 
>```
>
>**Прочее:**  
>```  
