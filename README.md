...
###### (*По ходу изучения Java по этой книге, здесь буду сохранять основные моменты с примерами кода*)
...
><details><summary>Основы ввода-вывода</summary>
>
>
></details>
...
<details><summary>Краткая шпаргалка по сочетаниям клавиш в IntelliJ IDEA</summary>

>**Редактирование:**  
> 
>|Сочетания клавиш| Действия|
>|:--------------|:----------------------------|  
